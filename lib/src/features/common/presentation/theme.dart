...
class AppTheme {
  ...
  static TextTheme appMaterialBlackTheme = const TextTheme(
    displayLarge: TextStyle(debugLabel: 'blackMontserrat displayLarge', fontFamily: fontFamily, color: Colors.black54, decoration: TextDecoration.none,),
    displayMedium: TextStyle(debugLabel: 'blackMontserrat displayMedium', fontFamily: fontFamily, color: Colors.black54, decoration: TextDecoration.none,),
    displaySmall: TextStyle(debugLabel: 'blackMontserrat displaySmall', fontFamily: fontFamily, color: Colors.black54, decoration: TextDecoration.none,),
    headlineLarge: TextStyle(debugLabel: 'blackMontserrat headlineLarge', fontFamily: fontFamily, color: Colors.black54, decoration: TextDecoration.none,),
    headlineMedium: TextStyle(debugLabel: 'blackMontserrat headlineMedium', fontFamily: fontFamily, color: Colors.black54, decoration: TextDecoration.none,),
    headlineSmall: TextStyle(debugLabel: 'blackMontserrat headlineSmall', fontFamily: fontFamily, color: Colors.black87, decoration: TextDecoration.none,),
    titleLarge: TextStyle(debugLabel: 'blackMontserrat titleLarge', fontFamily: fontFamily, color: Colors.black87, decoration: TextDecoration.none,),
    titleMedium: TextStyle(debugLabel: 'blackMontserrat titleMedium', fontFamily: fontFamily, color:Colors.black87, decoration: TextDecoration.none, ),
    titleSmall: TextStyle(debugLabel: 'blackMontserrat titleSmall', fontFamily: fontFamily, color: Colors.black, decoration: TextDecoration.none,),
    bodyLarge: TextStyle(debugLabel: 'blackMontserrat bodyLarge', fontFamily: fontFamily, color: Colors.black87, decoration: TextDecoration.none,),
    bodyMedium: TextStyle(debugLabel: 'blackMontserrat bodyMedium', fontFamily: fontFamily, color: Colors.black87, decoration: TextDecoration.none,),
    bodySmall: TextStyle(debugLabel: 'blackMontserrat bodySmall', fontFamily: fontFamily, color: Colors.black54, decoration: TextDecoration.none,),
    labelLarge: TextStyle(debugLabel: 'blackMontserrat labelLarge', fontFamily: fontFamily, color: Colors.black87, decoration: TextDecoration.none,),
    labelMedium: TextStyle(debugLabel: 'blackMontserrat labelMedium', fontFamily: fontFamily, color: Colors.black, decoration: TextDecoration.none,),
    labelSmall: TextStyle(debugLabel: 'blackMontserrat labelSmall', fontFamily: fontFamily, color: Colors.black, decoration: TextDecoration.none,),
  );

  static TextTheme appMaterialWhiteTheme = const TextTheme(
    displayLarge: TextStyle(debugLabel: 'whiteMontserrat displayLarge', fontFamily: fontFamily, color: Colors.white70, decoration: TextDecoration.none,),
    displayMedium: TextStyle(debugLabel: 'whiteMontserrat displayMedium', fontFamily: fontFamily, color: Colors.white70, decoration: TextDecoration.none,),
    displaySmall: TextStyle(debugLabel: 'whiteMontserrat displaySmall', fontFamily: fontFamily, color: Colors.white70, decoration: TextDecoration.none,),
    headlineLarge: TextStyle(debugLabel: 'whiteMontserrat headlineLarge', fontFamily: fontFamily, color: Colors.white70, decoration: TextDecoration.none,),
    headlineMedium: TextStyle(debugLabel: 'whiteMontserrat headlineMedium', fontFamily: fontFamily, color: Colors.white70, decoration: TextDecoration.none,),
    headlineSmall: TextStyle(debugLabel: 'whiteMontserrat headlineSmall', fontFamily: fontFamily, color: Colors.white, decoration: TextDecoration.none,),
    titleLarge: TextStyle(debugLabel: 'whiteMontserrat titleLarge', fontFamily: fontFamily, color: Colors.white, decoration: TextDecoration.none,),
    titleMedium: TextStyle(debugLabel: 'whiteMontserrat titleMedium', fontFamily: fontFamily, color:Colors.white, decoration: TextDecoration.none, ),
    titleSmall: TextStyle(debugLabel: 'whiteMontserrat titleSmall', fontFamily: fontFamily, color: Colors.white, decoration: TextDecoration.none,),
    bodyLarge: TextStyle(debugLabel: 'whiteMontserrat bodyLarge', fontFamily: fontFamily, color: Colors.white, decoration: TextDecoration.none,),
    bodyMedium: TextStyle(debugLabel: 'whiteMontserrat bodyMedium', fontFamily: fontFamily, color: Colors.white, decoration: TextDecoration.none,),
    bodySmall: TextStyle(debugLabel: 'whiteMontserrat bodySmall', fontFamily: fontFamily, color: Colors.white70, decoration: TextDecoration.none,),
    labelLarge: TextStyle(debugLabel: 'whiteMontserrat labelLarge', fontFamily: fontFamily, color: Colors.white, decoration: TextDecoration.none,),
    labelMedium: TextStyle(debugLabel: 'whiteMontserrat labelMedium', fontFamily: fontFamily, color: Colors.white, decoration: TextDecoration.none,),
    labelSmall: TextStyle(debugLabel: 'whiteMontserrat labelSmall', fontFamily: fontFamily, color: Colors.white, decoration: TextDecoration.none,),
  );
